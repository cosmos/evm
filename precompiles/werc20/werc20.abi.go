...
var _ abi.Method = (*WithdrawCall)(nil)

const WithdrawCallStaticSize = 32

var _ abi.Tuple = (*WithdrawCall)(nil)

// WithdrawCall represents an ABI tuple
type WithdrawCall struct {
	Wad *big.Int
}

// EncodedSize returns the total encoded size of WithdrawCall
func (t WithdrawCall) EncodedSize() int {
	dynamicSize := 0

	return WithdrawCallStaticSize + dynamicSize
}

// EncodeTo encodes WithdrawCall to ABI bytes in the provided buffer
func (value WithdrawCall) EncodeTo(buf []byte) (int, error) {
	// Encode tuple fields
	dynamicOffset := WithdrawCallStaticSize // Start dynamic data after static section
	// Field Wad: uint256
	if _, err := abi.EncodeUint256(value.Wad, buf[0:]); err != nil {
		return 0, err
	}
...
// Encode encodes WithdrawCall to ABI bytes
func (value WithdrawCall) Encode() ([]byte, error) {
	buf := make([]byte, value.EncodedSize())
	if _, err := value.EncodeTo(buf); err != nil {
		return nil, err
	}
...
// Decode decodes WithdrawCall from ABI bytes in the provided buffer
func (t *WithdrawCall) Decode(data []byte) (int, error) {
	if len(data) < 32 {
		return 0, io.ErrUnexpectedEOF
	}
	var (
	...
	dynamicOffset := 32
	// Decode static field Wad: uint256
	t.Wad, _, err = abi.DecodeUint256(data[0:])
	if err != nil {
		return 0, err
	}
	return dynamicOffset, nil
...
// GetMethodName returns the function name
func (t WithdrawCall) GetMethodName() string {
	return "withdraw"
}
...
// EncodeWithSelector encodes withdraw arguments to ABI bytes including function selector
func (t WithdrawCall) EncodeWithSelector() ([]byte, error) {
	result := make([]byte, 4+t.EncodedSize())
...
// NewWithdrawCall constructs a new WithdrawCall
...
// WithdrawReturn represents the output arguments for withdraw function
...
var (
	...
	DepositEventTopic = common.Hash{0xe1, 0xff, 0xfc, 0xc4, 0x92, 0x3d, 0x04, 0xb5, 0x59, 0xf4, 0xd2, 0x9a, 0x8b, 0xfc, 0x6c, 0xda, 0x04, 0xeb, 0x5b, 0x0d, 0x3c, 0x46, 0x07, 0x51, 0xc2, 0x40, 0x2c, 0x5c, 0x5c, 0xc9, 0x10, 0x9c}
	...
	WithdrawalEventTopic = common.Hash{0x7f, 0xcf, 0x53, 0x2c, 0x15, 0xf0, 0xa6, 0xdb, 0x0b, 0xd6, 0xd0, 0xe0, 0x38, 0xbe, 0xa7, 0x1d, 0x30, 0xd8, 0x08, 0xc7, 0xd9, 0x8c, 0xb3, 0xbf, 0x72, 0x68, 0xa9, 0x5b, 0xf5, 0x08, 0x1b, 0x65}
)
...
func (e DepositEventIndexed) EncodeTopics() ([]common.Hash, error) {
	...
	topics = append(topics, DepositEventTopic)
	{
		// Dst
		var hash common.Hash
		if _, err := abi.EncodeAddress(e.Dst, hash[:]); err != nil {
			return nil, err
		}
		topics = append(topics, hash)
	}
...
func (e *DepositEventIndexed) DecodeTopics(topics []common.Hash) error {
	...
	var err error
	e.Dst, _, err = abi.DecodeAddress(topics[1][:])
	if err != nil {
		return err
	}
	return nil
...
const DepositEventDataStaticSize = 32
...
// WithdrawalEvent represents the Withdrawal event
var _ abi.Event = (*WithdrawalEvent)(nil)

type WithdrawalEvent struct {
	WithdrawalEventIndexed
	WithdrawalEventData
}

// NewWithdrawalEvent constructs a new Withdrawal event
...
// GetEventName returns the event name
func (e WithdrawalEvent) GetEventName() string {
	return "Withdrawal"
}

// GetEventID returns the event ID (topic)
func (e WithdrawalEvent) GetEventID() common.Hash {
	return WithdrawalEventTopic
}

// Withdrawal represents an ABI event
type WithdrawalEventIndexed struct {
	Src common.Address
}

// EncodeTopics encodes indexed fields of Withdrawal event to topics
func (e WithdrawalEventIndexed) EncodeTopics() ([]common.Hash, error) {
	topics := make([]common.Hash, 0, 2)
	topics = append(topics, WithdrawalEventTopic)
	{
		// Src
		var hash common.Hash
		if _, err := abi.EncodeAddress(e.Src, hash[:]); err != nil {
			return nil, err
		}
		topics = append(topics, hash)
	}
...
// DecodeTopics decodes indexed fields of Withdrawal event from topics, ignore hash topics
func (e *WithdrawalEventIndexed) DecodeTopics(topics []common.Hash) error {
	if len(topics) != 2 {
		return fmt.Errorf("invalid number of topics for Withdrawal event: expected 2, got %d", len(topics))
	}
	if topics[0] != WithdrawalEventTopic {
		return fmt.Errorf("invalid event topic for Withdrawal event")
	}
	var err error
	e.Src, _, err = abi.DecodeAddress(topics[1][:])
	if err != nil {
		return err
	}
	return nil
...
const WithdrawalEventDataStaticSize = 32

var _ abi.Tuple = (*WithdrawalEventData)(nil)

// WithdrawalEventData represents an ABI tuple
type WithdrawalEventData struct {
	Wad *big.Int
}

// EncodedSize returns the total encoded size of WithdrawalEventData
func (t WithdrawalEventData) EncodedSize() int {
	dynamicSize := 0

	return WithdrawalEventDataStaticSize + dynamicSize
}

// EncodeTo encodes WithdrawalEventData to ABI bytes in the provided buffer
func (value WithdrawalEventData) EncodeTo(buf []byte) (int, error) {
	// Encode tuple fields
	dynamicOffset := WithdrawalEventDataStaticSize // Start dynamic data after static section
	// Field Wad: uint256
	if _, err := abi.EncodeUint256(value.Wad, buf[0:]); err != nil {
		return 0, err
	}
...
// Encode encodes WithdrawalEventData to ABI bytes
func (value WithdrawalEventData) Encode() ([]byte, error) {
	buf := make([]byte, value.EncodedSize())
	if _, err := value.EncodeTo(buf); err != nil {
		return nil, err
	}
...
// Decode decodes WithdrawalEventData from ABI bytes in the provided buffer
func (t *WithdrawalEventData) Decode(data []byte) (int, error) {
	if len(data) < 32 {
		return 0, io.ErrUnexpectedEOF
	}
	var (
