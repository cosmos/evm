...
func (p *Precompile) ClaimRewards(
	...
	if err != nil {
		return nil, cosmosErrorRegistry.ResolveQueryError(p.ABI, ClaimRewardsMaxValidatorsQueryMethod, err, nil).Err
	}
	...
	if err != nil {
		return nil, cosmosErrorRegistry.ResolveQueryError(p.ABI, ClaimRewardsGetDelegatorValidatorsQueryMethod, err, nil).Err
	}
	...
	for _, validator := range res.Validators {
		...
		if err != nil {
			return nil, cosmosErrorRegistry.ResolveMsgServerError(p.ABI, ClaimRewardsWithdrawDelegationRewardsMsgMethod, err, nil).Err
		}
...
func (p Precompile) SetWithdrawAddress(
	...
	if _, err = p.distributionMsgServer.SetWithdrawAddress(ctx, msg); err != nil {
		return nil, cosmosErrorRegistry.ResolveMsgServerError(p.ABI, SetWithdrawAddressMethod, err, nil).Err
	}
...
func (p *Precompile) WithdrawDelegatorReward(
	...
	if err != nil {
		return nil, cosmosErrorRegistry.ResolveMsgServerError(p.ABI, WithdrawDelegatorRewardMethod, err, nil).Err
	}
...
func (p *Precompile) WithdrawValidatorCommission(
	...
	if err != nil {
		return nil, cosmosErrorRegistry.ResolveMsgServerError(p.ABI, WithdrawValidatorCommissionMethod, err, nil).Err
	}
...
func (p *Precompile) FundCommunityPool(
	...
	if err != nil {
		return nil, cosmosErrorRegistry.ResolveMsgServerError(p.ABI, FundCommunityPoolMethod, err, nil).Err
	}
...
func (p *Precompile) DepositValidatorRewardsPool(
	...
	if err != nil {
		return nil, cosmosErrorRegistry.ResolveMsgServerError(p.ABI, DepositValidatorRewardsPoolMethod, err, nil).Err
	}
