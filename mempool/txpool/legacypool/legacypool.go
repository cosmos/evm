...
func (pool *LegacyPool) runReorg(done chan struct{}, reset *txpoolResetRequest, dirtyAccounts *accountSet, events map[common.Address]*SortedMap) {
	...
	promoted, possiblePromotions := pool.promoteExecutables(promoteAddrs, reset)
	...
	if reset != nil {
		...
		pool.demoteUnexecutables(height)
...
func (pool *LegacyPool) promoteExecutables(
	accounts []common.Address,
	reset *txpoolResetRequest,
) (promoted []*types.Transaction, leftovers *accountSet) {
...
func (pool *LegacyPool) demoteUnexecutables(height int64) {
