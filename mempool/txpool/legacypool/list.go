...
func (l *list) CostFilter(costLimit *uint256.Int, gasLimit uint64) (types.Transactions, types.Transactions) {
...
func (l *list) Filter(filterFn func(tx *types.Transaction) bool) ([]*types.Transaction, []*types.Transaction) {
