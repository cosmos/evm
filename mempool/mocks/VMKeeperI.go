...
func (_m *VMKeeperI) KVStoreKeys() map[string]v2types.StoreKey {
	ret := _m.Called()
...
func (_m *VMKeeperI) TransientStoreKeys() map[string]*v2types.TransientStoreKey {
	ret := _m.Called()
	...
	var r0 map[string]*v2types.TransientStoreKey
	if rf, ok := ret.Get(0).(func() map[string]*v2types.TransientStoreKey); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(map[string]*v2types.TransientStoreKey)
		}
	}
