...
- [\#1182](https://github.com/cosmos/evm/pull/1182) Fix `eth_estimateGas` under-reporting gas on native precompile calls by preserving `KvGasConfig` for precompile recipients in simulation context.
