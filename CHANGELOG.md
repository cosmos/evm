...
- [\#1300](https://github.com/cosmos/evm/pull/1300) Include the gas used by the preceding eth txs of the block in `eth_getTransactionReceipt`'s `cumulativeGasUsed`, matching `eth_getBlockReceipts`.
