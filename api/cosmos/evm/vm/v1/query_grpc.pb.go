...
type QueryClient interface {
	// Account queries an Ethereum account's state.
	Account(ctx context.Context, in *QueryAccountRequest, opts ...grpc.CallOption) (*QueryAccountResponse, error)
	// CosmosAccount queries an Ethereum account's corresponding Cosmos Address.
	CosmosAccount(ctx context.Context, in *QueryCosmosAccountRequest, opts ...grpc.CallOption) (*QueryCosmosAccountResponse, error)
	// ValidatorAccount queries an Ethereum account associated with a validator's consensus address.
	...
	// Balance queries the balance of the EVM denomination for a single account.
	Balance(ctx context.Context, in *QueryBalanceRequest, opts ...grpc.CallOption) (*QueryBalanceResponse, error)
	// Storage queries the EVM storage for a contract account at a specific key.
	Storage(ctx context.Context, in *QueryStorageRequest, opts ...grpc.CallOption) (*QueryStorageResponse, error)
	// Code queries the contract bytecode for a single account.
	Code(ctx context.Context, in *QueryCodeRequest, opts ...grpc.CallOption) (*QueryCodeResponse, error)
	// Params queries the parameters of the x/vm module.
	...
	// TraceBlock implements the `debug_traceBlockByNumber` and `debug_traceBlockByHash` rpc apis.
	...
	// BaseFee queries the base fee of the parent block, similar to the feemarket module's method, but also checks London hardfork status.
	...
	// GlobalMinGasPrice queries the minimum global gas price, converting to 18 decimals if the EVM denomination has a different precision.
