...
func (k Keeper) ConvertERC20(
	...
	pair, err := k.MintingEnabled(ctx, sender.String(), receiver.String(), receiver, msg.ContractAddress)
	if err != nil {
		return nil, err
	}
...
func (k Keeper) ConvertCoin(
	...
	pair, err := k.MintingEnabled(ctx, sender.String(), receiver.String(), receiver.Bytes(), msg.Coin.Denom)
	if err != nil {
		return nil, err
	}
