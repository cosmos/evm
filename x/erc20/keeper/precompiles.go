...
func (k Keeper) GetERC20PrecompileInstance(
	...
	if available := isDynamic; !available {
...
// RegisterPrecompileCodeHash checks if a new precompile already exists and registers the code hash it is not
func (k Keeper) RegisterPrecompileCodeHash(ctx sdk.Context, addr common.Address) error {
...
func (k Keeper) EnableDynamicPrecompile(ctx sdk.Context, address common.Address) error {
	...
	if err := k.RegisterPrecompileCodeHash(ctx, address); err != nil {
		return err
	}
