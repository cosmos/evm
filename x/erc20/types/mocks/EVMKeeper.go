...
// CallEVM provides a mock function with given fields: ctx, args, from, contract, commit, gasCap
func (_m *EVMKeeper) CallEVM(ctx types.Context, args abi.Method, from common.Address, contract common.Address, commit bool, gasCap *big.Int) (*vmtypes.MsgEthereumTxResponse, error) {
	var _ca []interface{}
	_ca = append(_ca, ctx, args, from, contract, commit, gasCap)
	ret := _m.Called(_ca...)
	...
	var r0 *vmtypes.MsgEthereumTxResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(types.Context, abi.Method, common.Address, common.Address, bool, *big.Int) (*vmtypes.MsgEthereumTxResponse, error)); ok {
		return rf(ctx, args, from, contract, commit, gasCap)
	}
	if rf, ok := ret.Get(0).(func(types.Context, abi.Method, common.Address, common.Address, bool, *big.Int) *vmtypes.MsgEthereumTxResponse); ok {
		r0 = rf(ctx, args, from, contract, commit, gasCap)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*vmtypes.MsgEthereumTxResponse)
		}
	...
	if rf, ok := ret.Get(1).(func(types.Context, abi.Method, common.Address, common.Address, bool, *big.Int) error); ok {
		r1 = rf(ctx, args, from, contract, commit, gasCap)
	} else {
		r1 = ret.Error(1)
	}
