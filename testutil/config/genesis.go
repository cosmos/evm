...
func NewErc20GenesisState() *erc20types.GenesisState {
	...
	erc20GenState.NativePrecompiles = []string{DefaultWevmosContractMainnet}
...
func NewMintGenesisState() *minttypes.GenesisState {
	...
	mintGenState.Params.MintDenom = evmtypes.CreateDenomStr(DefaultDecimals, DefaultDisplayDenom)
