...
var mnemonics = []string{
	...
	"maximum display century economy unlock van census kite erxx	ror heart snow filter midnight usage egg venture cash kick motor survey drastic edge muffin visual",
