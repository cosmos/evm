...
// NewExampleApp returns a reference to an initialized App.
func New(
	logger log.Logger,
	db dbm.DB,
	...
	*/
	...
	app.ModuleManager = module.NewManager(
		...
		distr.NewAppModule(appCodec, app.DistributionKeeper, app.AccountKeeper, app.BankKeeper, app.StakingKeeper, nil),
