...
require (
	...
	github.com/cometbft/cometbft v0.39.0-beta.1.0.20251022164134-9f097da0cd62
...
replace github.com/cometbft/cometbft => github.com/cometbft/cometbft v0.39.0-beta.2.0.20251106072418-a365db95eeec
