...
func TestP256PrecompileTestSuiteWithBlockSTM(t *testing.T) {
	create := testapp.ToEvmAppCreator[evm.P256PrecompileApp](integration.CreateEvmdWithBlockSTM, "evm.P256PrecompileApp")
	s := p256.NewPrecompileTestSuite(create)
	suite.Run(t, s)
}
...
func TestP256PrecompileIntegrationTestSuiteWithBlockSTM(t *testing.T) {
	create := testapp.ToEvmAppCreator[evm.P256PrecompileApp](integration.CreateEvmdWithBlockSTM, "evm.P256PrecompileApp")
	p256.TestPrecompileIntegrationTestSuite(t, create)
}
