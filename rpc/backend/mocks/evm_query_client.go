...
// Precompile provides a mock function with given fields: ctx, in, opts
func (_m *EVMQueryClient) Precompile(ctx context.Context, in *types.QueryPrecompileRequest, opts ...grpc.CallOption) (*types.QueryPrecompileResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for Precompile")
	}

	var r0 *types.QueryPrecompileResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *types.QueryPrecompileRequest, ...grpc.CallOption) (*types.QueryPrecompileResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *types.QueryPrecompileRequest, ...grpc.CallOption) *types.QueryPrecompileResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*types.QueryPrecompileResponse)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *types.QueryPrecompileRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
