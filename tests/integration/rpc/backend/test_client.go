...
func RegisterHeaderByHash(
	...
	client.On("HeaderByHash", rpc.NewContextWithHeight(1), bytes.HexBytes{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0}).
...
func RegisterHeaderByHashNotFound(client *mocks.Client, hash common.Hash, tx []byte) {
	client.On("HeaderByHash", rpc.NewContextWithHeight(1), bytes.HexBytes(hash.Bytes())).
...
func RegisterHeader(client *mocks.Client, height *int64, tx []byte) *coretypes.ResultHeader {
	...
	client.On("Header", rpc.NewContextWithHeight(*height), mock.AnythingOfType("*int64")).Return(resHeader, nil)
	return resHeader
}
...
func RegisterHeaderNotFound(client *mocks.Client, height int64) {
	client.On("Header", rpc.NewContextWithHeight(height), mock.MatchedBy(func(arg *int64) bool {
