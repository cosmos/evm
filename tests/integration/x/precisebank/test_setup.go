...
func (s *KeeperIntegrationTestSuite) SetupTest() {
	s.SetupTestWithChainConfig(testconfig.SixDecimalsChainConfig)
}

func (s *KeeperIntegrationTestSuite) SetupTestWithChainConfig(chainConfig testconfig.ChainConfig) {
