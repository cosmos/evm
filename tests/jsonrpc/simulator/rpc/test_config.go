	...
	return []types.TestCategory{
		...
		},
		{
			...
			Methods: []types.TestMethod{
				...
				{Name: ns.MethodNamePersonalInitializeWallet, Handler: func(rCtx *types.RpcContext) (*types.RpcResult, error) {
				...
				{Name: ns.MethodNamePersonalUnpair, Handler: func(rCtx *types.RpcContext) (*types.RpcResult, error) {
				...
				{Name: ns.MethodNamePersonalUnlockAccount, Handler: func(rCtx *types.RpcContext) (*types.RpcResult, error) {
				...
				{Name: ns.MethodNamePersonalLockAccount, Handler: func(rCtx *types.RpcContext) (*types.RpcResult, error) {
