...
`,
	...
	cmd.Flags().String(server.FlagBlockExecutor, serverconfig.BlockExecutorBlockSTM, "block executor mode (block-stm|sequential)")
	...
	cmd.Flags().Bool(server.FlagBlockSTMPreEstimate, true, "enable pre-estimation for block-stm execution")
